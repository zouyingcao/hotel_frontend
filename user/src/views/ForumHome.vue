<template>
    <div class="右侧页面">
        <el-card class="页面内容" v-for="(item, index) in forum" :key="index" @click.native="tocontent(item.id)" shadow="hover">
            ...
            <div class="用户ID" style="margin-left:25px; color:gray">
                用户ID : {{item.userId}}
            </div>
            <div class="创建时间" style="margin-left:25px; color:gray">
    ...
    data(){
        return{
            ...
            用户信息: {
                ...
                // "phone": "18293635616",
                // "avatar": "http://127.0.0.1:8080/upload/2021/07/23/c66d1d2172c740f2bfcf0d762348da03.png",
                // "gender": "男",
                // "age": 19,
                // "foodPreference": "新鲜水果",
                // "signature": "我爱吃！",
